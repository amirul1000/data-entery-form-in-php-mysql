...
?>
<a href="index.php?cmd=edit" class="btn green"><i class="fa fa-plus-circle"></i> Add a <?=ucwords(str_replace("_"," ","bsicclass"))?></a> <br><br>
					         ...
					         <div class="table-responsive">	
				                <table align="right">
									  <TR>
										<TD  nowrap="nowrap">
										  <?php
											  $hash    =  getTableFieldsName("bsicclass");
										...
										<td nowrap="nowrap" align="right">
										  <input type="hidden" name="cmd" id="cmd" value="search_bsicclass" >
			  ...
			  <td>GreaterThan19</td>
						 ...
						 ?>
							<tr bgcolor="<?=$row?>" onmouseover=" this.style.background='#ECF5B6'; " onmouseout=" this.style.background='<?=$row?>'; ">
							  <td><?=$arr[$i]['Cetegory']?></td>
			  <td><?=$arr[$i]['Divisions']?></td>
			  <td><?=$arr[$i]['Group']?></td>
			  <td><?=$arr[$i]['Class']?></td>
			  <td><?=$arr[$i]['ClassDescription']?></td>
			  <td><?=$arr[$i]['ByForce']?></td>
			  <td><?=$arr[$i]['LessThan20']?></td>
			  <td><?=$arr[$i]['GreaterThan19']?></td>
