...
?>
<a href="index.php?cmd=edit" class="btn green"><i class="fa fa-plus-circle"></i> Add a <?=ucwords(str_replace("_"," ","municipality"))?></a> <br><br>
					         ...
					         <div class="table-responsive">	
				                <table align="right">
									  <TR>
										<TD  nowrap="nowrap">
										  <?php
											  $hash    =  getTableFieldsName("municipality");
										...
										<td nowrap="nowrap" align="right">
										  <input type="hidden" name="cmd" id="cmd" value="search_municipality" >
			  ...
			  <td>Status</td>
						 ...
						 ?>
							<tr bgcolor="<?=$row?>" onmouseover=" this.style.background='#ECF5B6'; " onmouseout=" this.style.background='<?=$row?>'; ">
							  <td><?=$arr[$i]['card_type']?></td>
			  <td>
		                            <?php
									    unset($info2);        
										$info2['table']    = zilla;	
										$info2['fields']   = array("card_type");	   	   
										$info2['where']    =  "1 AND id='".$arr[$i]['zilla_id']."' LIMIT 0,1";
										$res2  =  $db->select($info2);
										echo $res2[0]['card_type'];	
					                ?>
							   </td>
			  <td>
		                            <?php
									    unset($info2);        
										$info2['table']    = municipality;	
										$info2['fields']   = array("card_type");	   	   
										$info2['where']    =  "1 AND id='".$arr[$i]['municipality_id']."' LIMIT 0,1";
										$res2  =  $db->select($info2);
										echo $res2[0]['card_type'];	
					                ?>
							   </td>
			  <td><?=$arr[$i]['municipality_name_comite_eng']?></td>
			  <td><?=$arr[$i]['municipality_name_comite_bng']?></td>
			  <td><?=$arr[$i]['rmo']?></td>
			  <td><?=$arr[$i]['status']?></td>
