<?php
	   ...
	   switch($cmd)
	   {
		  ...
		  case 'add': 
				...
				{
					$data['Establishment_cd']   = getMaxId($db);
				}
...
//Protect same image name
 ...
 {	  
    $info["table"] = "tblallestablishment";
	$info["fields"] = array("tblallestablishment.*"); 
	$info["where"]   = "1  ORDER BY Establishment_cd DESC  LIMIT 0, 1";
						
	
	$arr =  $db->select($info);
	
	if($arr[0]['Establishment_cd']>=99000001)
	{
		return  $arr[0]['Establishment_cd']+1;
	}
	else
	{
		return 99000001;
